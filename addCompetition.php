...
<body>
      ...
      <button type="button" ><a href="addCompetition.php">New Questions</a></button>
        ...
        <p id="ttime"></p> -->
          ...
          <form action="addCompetition.php" method="post" style="text-align:center;">

          <input type="text" id="compete" name="compete" value="Addition" hidden>
