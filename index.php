      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-4 text-center wow fadeInUp">
            <img class="header-img" src="img/math3.jpg" alt="Header Image">
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 margin-30">
            <h2>About Us</h2><br />
            <p>Math for Kids is an educational platform where children between the ages 6-11 can build their mathematical skills. We offer challenge questions where the kids can attempt to solve and workout. Solutions are provided in a manner that is understandable  where the child has failed a given question. </p><br />
            <blockquote>
          ...
          <div class="col-sm-6 wow fadeInUpBig">
            <img class="main1-img img-responsive pull-right" src="img/math4.png" alt="Main1 Image">
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="main2">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 wow fadeInUpBig">
            <img class="main2-img pull-left" src="img/main22.jpg" alt="Main2 Image">
          </div>
        
          <div class="col-sm-6 margin-30">
            <h2>What we Offer</h2><br />
            <p><ul style="font-size: large"; ><strong>
              <li>Math age 7-8 easy</li><br>
              <li>Math age 7-8 difficult</li><br>
              <li>Math age 8-9 easy</li><br>
              <li>Math age 8-9 difficult</li>
            </strong>
            </ul> </p><br />
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 text-center">
            <h2 class="white">Check out our basic addition and subtraction video tutorials</h2>
            <a href="#" class="btn btn-primary btn-lg">CLICK <i class="fa fa-play"></i></a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="bottom">
      <div class="container">
        ...
        <div class="row margin-40">
          <div class="col-sm-12 text-center">
            <h3 style="color: black"><em>Connect with us via</em></h3>
